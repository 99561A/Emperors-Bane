...
void autonomous( void ) {
  ...
  //Set Motor Velocities. This CAN be repeated within your program to change velocities.
    ...
    DriveLeftFront.rotateFor(6.25, vex::rotationUnits::rev, false); //Rotates the left front motor 1.5 revolution, and is not blocking.
    DriveLeftRear.rotateFor(6.25, vex::rotationUnits::rev, false); //Rotates the left rear motor 1.5 revolution, and is not blocking.
    DriveRightFront.rotateFor(-6.25, vex::rotationUnits::rev, false); //Rotates the right front motor 1.5 revolution, and is not blocking.
    DriveRightRear.rotateFor(-6.25, vex::rotationUnits::rev); //Rotates the right rear motor 1.5 revolution, and IS blocking.
