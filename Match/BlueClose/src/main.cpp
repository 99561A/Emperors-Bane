...
void autonomous( void ) {
  ...
  //Set Motor Velocities. This CAN be repeated within your program to change velocities.
    ...
    DriveLeftFront.rotateFor(.03, vex::rotationUnits::rev, false); //Rotates the left front motor 1.5 revolution, and is not blocking.
    DriveLeftRear.rotateFor(.03, vex::rotationUnits::rev, false); //Rotates the left rear motor 1.5 revolution, and is not blocking.
    DriveRightFront.rotateFor(.03, vex::rotationUnits::rev, false); //Rotates the right front motor 1.5 revolution, and is not blocking.
    DriveRightRear.rotateFor(.03, vex::rotationUnits::rev); //Rotates the right rear motor 1.5 revolution, and IS blocking.
    ...
    DriveLeftFront.rotateFor(-.12, vex::rotationUnits::rev, false); //Rotates the left front motor 1.5 revolution, and is not blocking.
    DriveLeftRear.rotateFor(-.12, vex::rotationUnits::rev, false); //Rotates the left rear motor 1.5 revolution, and is not blocking.
    DriveRightFront.rotateFor(-.12, vex::rotationUnits::rev, false); //Rotates the right front motor 1.5 revolution, and is not blocking.
    DriveRightRear.rotateFor(-.12, vex::rotationUnits::rev); //Rotates the right rear motor 1.5 revolution, and IS blocking.
    ...
    DriveLeftFront.rotateFor(-4.25, vex::rotationUnits::rev, false); //Rotates the left front motor 1.5 revolution, and is not blocking.
    DriveLeftRear.rotateFor(-4.25, vex::rotationUnits::rev, false); //Rotates the left rear motor 1.5 revolution, and is not blocking.
    DriveRightFront.rotateFor(4.25, vex::rotationUnits::rev, false); //Rotates the right front motor 1.5 revolution, and is not blocking.
    DriveRightRear.rotateFor(4.25, vex::rotationUnits::rev); //Rotates the right rear motor 1.5 revolution, and IS blocking.
   
     
    
    DriveLeftFront.rotateFor(-0.9, vex::rotationUnits::rev, false); //Rotates the left front motor 1.5 revolution, and is not blocking.
    DriveLeftRear.rotateFor(-0.9, vex::rotationUnits::rev, false); //Rotates the left rear motor 1.5 revolution, and is not blocking.
    DriveRightFront.rotateFor(-0.9, vex::rotationUnits::rev, false); //Rotates the right front motor 1.5 revolution, and is not blocking.
    DriveRightRear.rotateFor(-0.9, vex::rotationUnits::rev); //Rotates the right rear motor 1.5 revolution, and IS blocking.
    
    
    DriveLeftFront.rotateFor(3.25, vex::rotationUnits::rev, false); //Rotates the left front motor 1.5 revolution, and is not blocking.
    DriveLeftRear.rotateFor(3.25, vex::rotationUnits::rev, false); //Rotates the left rear motor 1.5 revolution, and is not blocking.
    DriveRightFront.rotateFor(-3.25, vex::rotationUnits::rev, false); //Rotates the right front motor 1.5 revolution, and is not blocking.
    DriveRightRear.rotateFor(-3.25, vex::rotationUnits::rev); //Rotates the right rear motor 1.5 revolution, and IS blocking.
