...
void autonomous( void ) {
  ...
  //Set Motor Velocities. This CAN be repeated within your program to change velocities.
    ...
    DriveLeftFront.rotateFor(.07, vex::rotationUnits::rev, false); //Rotates the left front motor 1.5 revolution, and is not blocking.
    DriveLeftRear.rotateFor(.07, vex::rotationUnits::rev, false); //Rotates the left rear motor 1.5 revolution, and is not blocking.
    DriveRightFront.rotateFor(.07, vex::rotationUnits::rev, false); //Rotates the right front motor 1.5 revolution, and is not blocking.
    DriveRightRear.rotateFor(.07, vex::rotationUnits::rev); //Rotates the right rear motor 1.5 revolution, and IS blocking.
    ...
    DriveLeftFront.rotateFor(1.5, vex::rotationUnits::rev, false); //Rotates the left front motor 1.5 revolution, and is not blocking.
    DriveLeftRear.rotateFor(1.5, vex::rotationUnits::rev, false); //Rotates the left rear motor 1.5 revolution, and is not blocking.
    DriveRightFront.rotateFor(-1.5, vex::rotationUnits::rev, false); //Rotates the right front motor 1.5 revolution, and is not blocking.
    DriveRightRear.rotateFor(-1.5, vex::rotationUnits::rev); //Rotates the right rear motor 1.5 revolution, and IS blocking.
    ...
    DriveLeftFront.rotateFor(3.5, vex::rotationUnits::rev, false); //Rotates the left front motor 1.5 revolution, and is not blocking.
    DriveLeftRear.rotateFor(3.5, vex::rotationUnits::rev, false); //Rotates the left rear motor 1.5 revolution, and is not blocking.
    DriveRightFront.rotateFor(-3.5, vex::rotationUnits::rev, false); //Rotates the right front motor 1.5 revolution, and is not blocking.
    DriveRightRear.rotateFor(-3.5, vex::rotationUnits::rev); //Rotates the right rear motor 1.5 revolution, and IS blocking.
